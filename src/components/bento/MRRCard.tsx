...
export default function MRRCard() {
  return (
    <div className="h-full bg-gradient-to-br from-green-500/75 to-emerald-500/80 backdrop-blur-lg border border-white/50 rounded-3xl p-6 flex flex-col justify-center text-white shadow-2xl hover:shadow-green-200/30 hover:border-white/60 transition-all duration-500 overflow-hidden relative group">
