  ...
  return (
    <div className="h-full bg-gradient-to-br from-emerald-500/80 to-green-400/85 backdrop-blur-lg border border-white/50 rounded-3xl p-4 sm:p-6 flex flex-col justify-center text-white shadow-2xl hover:shadow-green-200/30 hover:border-white/60 transition-all duration-500 relative group overflow-hidden hover:scale-[1.02]"
      ...
      <div className="relative z-10 text-center">
        ...
        <h3 className="font-bold text-base sm:text-lg mb-3 sm:mb-6">MRR Tracker</h3>

        <div className="space-y-2 sm:space-y-4 text-xs sm:text-sm">
          <div className="flex justify-between items-center">
            <span className="font-medium">Job:</span>
            <span className="font-bold text-sm sm:text-lg">€4,200</span>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-bold text-sm sm:text-lg">€0</span>
          </div>
          ...
          <div className="flex justify-between items-center pt-1 sm:pt-2">
            ...
            <span className="font-bold text-base sm:text-xl">€4,200</span>
          </div>
        </div>
      </div>
    </div>
