  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <h3 className="font-bold text-sm sm:text-xl mb-2 sm:mb-3">Need developers for a project?</h3>

        <p className="text-xs sm:text-sm mb-3 sm:mb-4 opacity-90 leading-relaxed">
          Send me an email and we'll make you an offer!
        </p>

        <div className="bg-white/20 rounded-lg px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium">
          Click to email me
        </div>
      </div>
    </a>
